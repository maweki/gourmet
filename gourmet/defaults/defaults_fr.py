...
class Language(AbstractLanguage):
    ...
    INGREDIENT_DATA = [## l é g u m e s
        ...
        ["pois chiche ou garbanzos", "pois chiche ou garbanzos", "fruits et légumes"],  # chickpeas, garbanzos, or ceci beans
        ...
        ["haricots de Lima ou haricots jaunes", "haricots de Lima ou haricots jaunes", "fruits et légumes"],  # lima bean or butter bean
